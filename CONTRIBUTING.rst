...
Swagger Tester could always use more documentation, whether as part of the
official Swagger Tester docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_name_here/swagger-tester.git
